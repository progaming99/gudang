<div class="card shadow-sm border-bottom-primary">
    <div class="card-header bg-white py-3">
        <div class="row">
            ...
            <div class="col-auto">
                <a href="<?= base_url('Satuan/tambah') ?>" class="btn btn-sm btn-primary btn-icon-split">
                    <span class="icon">
        ...
        <table class="table table-striped" id="dataTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $j['nama_satuan']; ?></td>
                    <td>
                        <a href="<?= base_url('satuan/edit/') . $j['id_satuan'] ?>"
                            class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>

                        <a href="<?= base_url('satuan/delete/') . $j['id_satuan'] ?>"
