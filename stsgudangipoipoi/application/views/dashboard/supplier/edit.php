                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nama_supplier', $supplier['nama_supplier']); ?>"
                                name="nama_supplier" id="nama_supplier" type="text" class="form-control"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('no_telp', $supplier['no_telp']); ?>" name="no_telp"
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <textarea name="alamat" id="alamat" class="form-control" rows="4"
                                placeholder="Alamat..."><?= set_value('alamat', $supplier['alamat']); ?></textarea>
                        </div>
