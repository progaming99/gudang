td<div class="card shadow-sm border-bottom-primary">
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                if ($ban) :
                    ...
                    <tr>
                        <td><?= $no++; ?></td>
                        <td><?= $b->nomor_armada; ?></td>
                        <td><?= $b->nama_supir; ?></td>
                        <td><?= date('d F Y',strtotime("$b->tanggal_pasang")); ?></td>
                        <td><?= $b->nomor_seri_baru; ?></td>
                        <td><?= $b->harga; ?></td>
                        <td>
                            ...
                            <a href="<?= base_url('Ban/hapus/') . $b->id_ban ?>"
