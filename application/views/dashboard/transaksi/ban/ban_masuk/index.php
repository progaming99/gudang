        ...
        <div class="row">
            <div class="col">
                <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                    Riwayat Data Ban Masuk
                </h4>
            </div>

            <div class="col-auto">
                <a href="<?= base_url('ban_masuk/tambah') ?>" class="btn btn-sm btn-primary btn-icon-split">
                    <span class="icon">
    ...
    <table class="table-responsive table-striped w-100 dt-responsive nowrap" id="dataTable">
        ...
        <tbody>
            <?php
                $no = 1;
                if ($ban_masuk) :
                    foreach ($ban_masuk as $bm) :
                ?>
            <tr>
                <td><?= $no++; ?></td>
                <td><?= $bm['id_ban_masuk']; ?></td>
                ...
                <?php if ($role == 'admin' || $role == 'finance'): ?>
                <td>
                    <a href="<?= base_url('ban_masuk/delete/') . $bm['id_ban_masuk'] ?>"
...
function filter() {
    ...
    window.location.href = `Ban_masuk?start_date=${startDate}&end_date=${endDate}`;
}

function resetFilter() {
    window.location.href = 'Ban_masuk'
}
</script>
