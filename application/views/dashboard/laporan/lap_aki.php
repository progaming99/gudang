                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-radio">
                            <input value="aki_masuk" type="radio" id="aki_masuk" name="transaksi"
                                class="custom-control-input">
                            <label class="custom-control-label" for="aki_masuk">Aki Masuk</label>
                        </div>

                        <div class="custom-control custom-radio">
                            <input value="aki_keluar" type="radio" id="aki_keluar" name="transaksi"
                                class="custom-control-input">
                            <label class="custom-control-label" for="aki_keluar">Aki Keluar</label>
                        </div>
