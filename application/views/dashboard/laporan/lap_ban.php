                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-radio">
                            <input value="ban_masuk" type="radio" id="ban_masuk" name="transaksi"
                                class="custom-control-input">
                            <label class="custom-control-label" for="ban_masuk">Ban Masuk</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input value="ban_keluar" type="radio" id="ban_keluar" name="transaksi"
                                class="custom-control-input">
                            <label class="custom-control-label" for="ban_keluar">Ban Keluar</label>
                        </div>
