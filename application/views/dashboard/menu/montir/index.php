<div class="card shadow-sm border-bottom-primary">
    <div class="card-header bg-white py-3">
        <div class="row">
            ...
            <div class="col-auto">
                <a href="<?= base_url('Montir/tambah') ?>" class="btn btn-sm btn-primary btn-icon-split">
                    <span class="icon">
        ...
        <table class="table table-striped" id="dataTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php if ($currentRole == 'admin' || $currentRole == 'finance'): ?>
                    <td>
                        <a href="<?= base_url('montir/edit/') . $j['id_montir'] ?>"
                            class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>

                        <a href="<?= base_url('montir/delete/') . $j['id_montir'] ?>"
