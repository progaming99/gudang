...
class Cetak_laporan extends CI_Controller
{
    ...
    {        
        $data['title'] = "Cetak keluar";
        
         // Cek peran pengguna saat ini
         $id_user = $this->session->userdata('id_user');
         $currentRole = $this->Cetak_model->get_user_role_by_id($id_user);
         ...
         $data['cetak_keluar'] = $this->Cetak_model->getCetakkeluar(null, null, $start_date, $end_date);
